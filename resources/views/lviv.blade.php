...
<div class="weatherItem even day">
    <img class="icon" src="https://assetambee.s3-us-west-2.amazonaws.com/weatherIcons/PNG/{{$response['data']['forecast'][0]['icon']}}.png">
    <div class="weatherCity">Львов</div>
    ...
    <div class="weatherRange">Влажность:{{$response['data']['forecast'][0]['humidity']}}  мм </div>
